...
const getScheduleById = async (req, res) => { // Get a schedule by ID
  const { id } = req.params;
  try {
...
const addSchedule = async (req, res) => { // Add a new schedule, function named addSchedule for adding a new schedule.
